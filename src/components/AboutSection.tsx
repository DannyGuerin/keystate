        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-4">
            <p className="text-lg leading-relaxed text-foreground">
              KEYSTATE helps estate agents strengthen their brand and client relationships with high-quality, custom-branded keyrings. Each keyring is designed to leave a lasting impression long after the handover, combining durable materials with your agency's logo for a professional, trustworthy finish. Whether for property completions, promotions, or local events, KEYSTATE provides a simple, reliable way to keep your name in your clients' hands — literally.
            </p>
          </div>
