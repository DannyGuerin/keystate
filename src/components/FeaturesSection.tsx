...
import simpleOrderingIcon from "@/assets/simple-ordering-icon.png";
const features = [{
  icon: Award,
  ...
  return <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          return <Card key={feature.title} className="border-2 hover:border-primary/20 transition-colors">
                <CardHeader>
                  {feature.title === "Premium Quality" ? <div className="w-16 h-16 mx-auto mb-4">
                      <img src={premiumQualityIcon} alt={feature.title} className="w-full h-full object-contain" />
                    </div> : feature.title === "Custom Branding" ? <div className="w-16 h-16 mx-auto mb-4">
                      <img src={customBrandingIcon} alt={feature.title} className="w-full h-full object-contain" />
                    </div> : feature.title === "Fast Delivery" ? <div className="w-16 h-16 mx-auto mb-4">
                      <img src={fastDeliveryIcon} alt={feature.title} className="w-full h-full object-contain" />
                    </div> : feature.title === "Simple Ordering" ? <div className="w-16 h-16 mx-auto mb-4">
                      <img src={simpleOrderingIcon} alt={feature.title} className="w-full h-full object-contain" />
                    </div> : loadingImages[feature.title] ? <Skeleton className="w-full h-32 rounded-lg mb-4" /> : featureImages[feature.title] ? <img src={featureImages[feature.title]} alt={feature.title} className="w-full h-32 object-cover rounded-lg mb-4" /> : <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
